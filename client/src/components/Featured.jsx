        ...
        {trending.map(trend => (
            ...
            <div key={trend.id} className="flex flex-col py-6 gap-5 relative">
              <Link to={`/products/${trend.id}`} className='relative'>
                <img src={trend.img} alt="" className='object-cover w-[200px] h-[200px] float-left md:w-[300px] md:h-[300px] lg:w-[350px] lg:h-[350px] xl:w-[400px] xl:h-[400px]' />
            ...
            <div className='flex flex-col px-1'>
                ...
                {trend.onSale && <span className=' text-gray-500 text-sm line-through pr-0.5'>£ {trend.oldPrice}</span>}
                £ {trend.price}
                </p>
            </div>
