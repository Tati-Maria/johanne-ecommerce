...
const initialState = {
    products: [
        ...
        },
        {
            ...
            desc: "Embrace the tropical vibe with this palm tree-printed bikini. The high-waisted bottoms and sweetheart neckline create a flattering silhouette that's perfect for any beach day.",
            price: 45.99,
            oldPrice: 55.99,
            img: brown2,
            img2: brown,
        ...
        },
        {
            ...
            name: "Floral Boho",
            desc: "Take on the tropics with this exotic bikini. Featuring a bold floral print and a strappy back design, this swimsuit is perfect for island adventures.",
            price: 35.99,
            oldPrice: 45.99,
            img: bohoFloral,
            img2: bohoFloral2,
        ...
        },
        {
            ...
            name: "Red Set",
            desc: "Bring a pop of color to the beach with this vibrant halter swimsuit. The plunging neckline and strappy back detailing make this suit a true standout.",
            price: 18.99,
            oldPrice: 25.99,
            img: brownset,
            img2: brownset2,
        ...
        },
        {
            ...
            name: "Cover Up Dress",
            desc: "Keep it cool and breezy with this sheer mesh cover-up. Perfect for layering over your swimsuit, this cover-up features a flowing silhouette and a vibrant sunset-inspired print.",
            price: 17.99,
            oldPrice: 25.99,
            img: coverDress,
            img2: coverDress2,
